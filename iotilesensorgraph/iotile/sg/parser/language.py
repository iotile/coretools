...
def _create_simple_statements():
    ...
    streamer_stmt = Group(Optional(Literal("manual")('manual')) + Optional(oneOf(u'encrypted signed')('security')) + Optional((Literal(u'realtime')('realtime') | Literal(u'broadcast')('broadcast'))) + Literal('streamer').suppress() -
