...
class AddStreamerRecord(SendErrorCheckingRPCRecord):
    ...
    def __init__(self, descriptor, address):
        ...
        super(AddStreamerRecord, self).__init__(address, AddStreamerRecord.RPC_ID, payload, response_size=4)
    ...
    def MatchQuality(cls, record_data, record_count=1):
        ...
        if cmd == AddStreamerRecord.RPC_ID:
    ...
    def FromBinary(cls, record_data, record_count=1):
        ...
        record type header) and it will decode it into a AddStreamerRecord.
