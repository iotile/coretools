...
import iotilebuild.mib.block

from iotilecore.hex8 import patch
...
def checksum_insertion_action(target, source, env):
	...
	result = patch.patch_retlw(ih, block.base_addr + iotilecore.mib.block.checksum_offset, block.stored_checksum, desired_check)
