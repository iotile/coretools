...
class MIBDescriptor:
	...
	def generate_config_h(self, filename):
		templ = RecursiveTemplate('configvariables.h', resource_filename(Requirement.parse("iotilebuild"), "iotilebuild/config/templates"))
	...
	def generate_config_c(self, filename):
		templ = RecursiveTemplate('configvariables.c', resource_filename(Requirement.parse("iotilebuild"), "iotilebuild/config/templates"))
		templ.add({'configvars': self.configs})
		out = templ.format_temp()
	...
	def generate_config_defaults_as(self, filename):
		templ = RecursiveTemplate('config_defaults_asm.as', resource_filename(Requirement.parse("iotilebuild"), "iotilebuild/config/templates"))
		templ.add({'configvars': self.configs})
		out = templ.format_temp()
