...
class TileBusProxyObject(object):
    ...
    def hardware_version(self):
        ...
        The hardware version is an up to 10 byte user readable string
        that is meant to encode any necessary information about the specific
        hardware that this tile is running on.  For example, if you have
        multiple assembly variants of a given tile, you could encode that
        information here.
    ...
    def check_hardware(self, expected):
        ...
        This convenience function is meant for ensuring that we are talking
        to a tile that has the correct hardware version.
