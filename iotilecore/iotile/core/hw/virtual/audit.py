...
RPCReceived = AuditEvent('RPCReceived', 'An RPC has been received (id=%(rpc_id)s, address=%(address)s, payload=%(payload)s)', frozenset(['rpc_id', 'address', 'payload']), frozenset())
