# -*- coding: utf-8 -*-
#
# IOTile CoreTools documentation build configuration file, created by
...
copyright = u'2019, Arch Systems Inc.'
...
htmlhelp_basename = 'IOTileCoreToolsdoc'
...
latex_documents = [
  (master_doc, 'IOTileCoreTools.tex', u'IOTile CoreTools Documentation',
   u'Arch Systems', 'manual'),
]
...
man_pages = [
    (master_doc, 'iotilecoretools', u'IOTile CoreTools Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'IOTileCoreTools', u'IOTile CoreTools Documentation',
   author, 'IOTileCoreTools', 'One line description of project.',
   'Miscellaneous'),
]
