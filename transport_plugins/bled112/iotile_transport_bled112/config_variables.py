...
def get_variables():
    ...
    conf_vars.append(["deduplicate-broadcasts", "bool", "Filter unchanging Broadcast V2 packets per device", "false"])
    conf_vars.append(["deduplicate-timeout", "int", "With 'deduplicate-broadcasts', report at least one packet every"
                                                    " 'this' seconds", 5])
